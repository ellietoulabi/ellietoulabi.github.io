...
<p>
I am currently completing my Master of Science in Computing Science at the <a href="https://www.ualberta.ca/en/computing-science/index.html" target="_blank" rel="noopener noreferrer">University of Alberta</a>, supervised by <a href="https://jrwright.info/" target="_blank" rel="noopener noreferrer">James R. Wright</a>. My research focuses on cooperative model-based reinforcement learning to understand and model how people act in strategic situations. More broadly, I aim to develop autonomous agents that learn, adapt, and coordinate in complex, non-stationary environments.
